...
const skipWhitespaceComments = configuration => state => {
    const findComment = () =>
        configuration.comments.findMap(comment => comment.open.matchFrom(state.input)(state.index).map(_ => comment));
...
const initialState = input =>
    mkRunningState(input)(0)(Tuple(1)(1))(undefined)(Tuple(1)(1))(0);
